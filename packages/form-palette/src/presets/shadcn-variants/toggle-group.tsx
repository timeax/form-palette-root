...
function normalizeOption(
   ...
   if (
      ...
      const rawValue =
         optionValue != null ? anyInput[optionValue] : anyInput.value ?? input;
      ...
      const icon =
         optionIcon != null ? anyInput[optionIcon] : anyInput.icon ?? undefined;
      const disabled =
         optionDisabled != null
      ...
      const meta =
         optionMeta != null ? anyInput[optionMeta] : anyInput.meta ?? undefined;
